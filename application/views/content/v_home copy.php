        ...
        <div class="text-center">
            ...
            <div class="tabs-product mt-5">
                <ul class="nav nav-tabs nav-type border-0 justify-content-center" id="myTab">
                    <?php foreach ($this->db->query("SELECT * FROM tbl_master_kategori")->result() as $mk) { ?>
                        <li class="nav-item">
                ...
                <div class="tab-content position-relative pt-5">
                    <?php foreach ($this->db->query("SELECT * FROM tbl_produk")->result() as $p) { ?>
                            ...
                            <div class="row gy-4 gy-md-0">
                                <div class="col-md-5">
                                        ...
                                        <?php foreach ($this->db->query("SELECT * FROM tbl_produk")->result() as $pWrarna) { ?>
                                            ...
                                            <div class="tab-pane fade <?php
                                                ...
                                                <div class="produk-tab">
                                                    <div class="tab-content position-relative pt-4">
                                                        <?php foreach ($this->db->query("SELECT b.id, b.image, b.header,a.id_produk FROM tbl_produk a LEFT JOIN tbl_produk_detail b ON b.header=a.id_produk WHERE a.id_produk = '" . $pWrarna->id_produk . "'")->result() as $pFullImage) { ?>
                                                            <div class="tab-pane fade <?php
                                                                                        if ($pFullImage->id != "") {
                                                                                            if ($pFullImage->id == 1) {
                                                                                                echo "show active";
                                                    ...
                                                    <ul class="nav nav-tabs border-0 justify-content-center mt-4" id="myTab">
                                                        <?php foreach ($this->db->query("SELECT b.id,b.image, b.header,a.id_produk FROM tbl_produk a LEFT JOIN tbl_produk_detail b ON b.header=a.id_produk WHERE a.id_produk = '" . $pWrarna->id_produk . "'")->result() as $pImage) { ?>
                                                            <li class="nav-item">
                                                                <a href="#tab-produk-<?= $pImage->id; ?>" class="nav-link <?php
                                                                                                                            if ($pImage->id != "") {
                                                                                                                                if ($pImage->id == 1) {
                                                                                                                                    echo "active";
                                                                                                                                }
                                    ...
                                    <ul class="nav nav-tabs nav-color border-0 mt-4 mt-md-5" id="myTab">
                                        <?php foreach ($this->db->query("SELECT * FROM tbl_master_warna")->result() as $mw) { ?>
                                            <style>
...
<section class="container-xxl product" hidden>
    <div class="container py-5">
        <div class="text-center">
            <div class="header-title">
                <h4>PRODUCTS</h4>
                    ...
                    <div class="tab-pane fade show active" id="tab-1">
                        <div class="row gy-4 gy-md-0">
                            <div class="col-md-5">
                                <!-- Tab Warna -->
                                <div class="tab-content position-relative pt-4">
                                    <div class="tab-pane fade show active" id="tab-color-1">
                                        <!-- Tabs Produk Image -->
                                        <div class="produk-tab">
                                            <div class="tab-content position-relative pt-4">
                                                <div class="tab-pane fade show active" id="tab-produk-1">
                                                    <div class="img">
                                                        <img src="assets/img/motor-1.png" class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                            ...
                                            <ul class="nav nav-tabs border-0 justify-content-center mt-4" id="myTab">
                                                <li class="nav-item">
                                                    <a href="#tab-produk-1" class="nav-link active" data-bs-toggle="tab">
                                                        <div class="img">
                                                            <img src="assets/img/tab-motor-1.png" class="img-fluid" alt="">
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#tab-produk-2" class="nav-link" data-bs-toggle="tab">
                                                        <div class="img">
                                                            <img src="assets/img/tab-motor-2.png" class="img-fluid" alt="">
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#tab-produk-3" class="nav-link" data-bs-toggle="tab">
                                                        <div class="img">
                                                            <img src="assets/img/tab-motor-3.png" class="img-fluid" alt="">
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#tab-produk-3" class="nav-link" data-bs-toggle="tab">
                                                        <div class="img">
                                                            <img src="assets/img/tab-motor-4.png" class="img-fluid" alt="">
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#tab-produk-3" class="nav-link" data-bs-toggle="tab">
                                                        <div class="img">
                                                            <img src="assets/img/tab-motor-5.png" class="img-fluid" alt="">
                                                        </div>
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <ul class="nav nav-tabs nav-color border-0 mt-4 mt-md-5" id="myTab">
                                    <li class="nav-item">
                                        <a href="#tab-color-1" class="nav-link active" data-bs-toggle="tab">
                                            <div class="box color-000000">

                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab-color-2" class="nav-link" data-bs-toggle="tab">
                                            <div class="box color-D7CB49">

                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab-color-3" class="nav-link" data-bs-toggle="tab">
                                            <div class="box color-7EBDB6">
                            ...
                            <div class="col-md-7">
                                <div class="spesification text-start">
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-6 col-lg-4">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="desk">
                                                        <span>Terkoneksi </span>
                                                        <p>Terkoneksi dengan Mobile Apps</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="breif-desk mt-4">
                                        ...
                                        <p>Barang akan dikirimkan dalam 3 bulan setelah pembayaran dilakukan. Setelah
                                            pesanan terkonfirmasi, customer akan di hubungi untuk melakukan verifikasi
                                            data terkait pengiriman unit motor dan pengurusan STNK dan BPKB. Saat terima
                                            motor pastikan CEK FISIK secara seksama sebelum tanda tangan di Berita Acara
                                            Serah Terima. STNK dan BPKB akan diserahkan 2-4 minggu setelah unit
                                            diterima.</p>
                                    </div>
                                </div>
                            </div>
