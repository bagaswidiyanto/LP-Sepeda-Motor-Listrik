                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="price my-4">
                                                <span>Harga</span>
                                                <?php if ($produkCore->idKat == 3) { ?>
                                                <p id="price">Rp
                                                    <?= number_format($produkCore->harga, 0, ",", "."); ?>
                                                </p>
                                                <?php } else { ?>
                                                <p>Rp
                                                    <?= number_format($produkCore->harga, 0, ",", "."); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="baterai">
                                                <div class="row">
                                                    <?php foreach ($this->db->query("SELECT * FROM tbl_baterai WHERE id_kategori = '" . $produkCore->idKat . "' ORDER BY id ASC")->result() as $baterai) { ?>
                                                    <div class="col-xl-4 col-md-6 col-4">
                                                        <a class="<?php
                                                            ...
                                                            <div class="box">
                                                                <p><?= $baterai->nama; ?></p>
                                                                <span hidden>Rp
                                                                    <?= number_format($baterai->harga, 0, ",", "."); ?></span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <?php } ?>
...
<section class="container-fluid video">
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-lg-12">
                <?php $vid = $this->db->query("SELECT a.id,a.nama, b.id_kategori, b.videoPlay FROM tbl_master_kategori a LEFT JOIN tbl_video b ON a.id = b.id_kategori ORDER BY a.id ASC")->row() ?>
                <video controls id="link-vid">
                    <source src="https://admin103.sepedamotorlistrik.net/upload/video/<?= $vid->videoPlay; ?>"
                        type="video/mp4">
                </video>
            </div>
        </div>
        ...
        <ul class="nav nav-tabs border-0 justify-content-center wow fadeInUp" data-wow-delay="0.3s" id="myTab">
            <?php foreach ($this->db->query("SELECT a.id,a.nama, b.id_kategori, b.videoPlay FROM tbl_master_kategori a LEFT JOIN tbl_video b ON a.id = b.id_kategori ORDER BY a.id ASC")->result() as $mk) {
                $id = $this->db->query("SELECT * FROM tbl_video ORDER BY id_kategori ASC")->row();
            ?>
            ...
            <li class="nav-item">
                <a class="nav-link  <?php
                                            ...
                                            ?>" data-bs-toggle="tab">
                    <?= $mk->nama; ?>
                    <source src="https://admin103.sepedamotorlistrik.net/upload/video/<?= $mk->videoPlay; ?>"
                        type="video/mp4">
                </a>
            </li>
            <?php } ?>
...
<section class="container-fluid service-point" id="service-point">
    <div class="container py-5">
        <div class="heading mb-5 wow fadeInUp" data-wow-delay="0.3s">
            <h2 class="fw-normal"><?= $dc4->title; ?></h2>
        </div>
